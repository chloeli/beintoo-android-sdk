...
public class MessagesRead extends Dialog{
	...
	public MessagesRead(Context context, UsersMessage m, MessagesList p) {
		...
		try {
			...
			String date = "<b>"+getContext().getString(R.string.messagedate)+"</b> "+(DateFormat.getDateTimeInstance(DateFormat.MEDIUM,DateFormat.SHORT,Locale.getDefault()).format(msgDate));
	...
	private void showDeleteAlert(){
		...
		builder.setMessage(current.getContext().getString(R.string.messageaskdelete))
	       .setCancelable(false)
