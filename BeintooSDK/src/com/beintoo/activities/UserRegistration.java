...
public class UserRegistration extends Dialog{
	...
	public UserRegistration(Context ctx) {
		...
		vs = (ViewSwitcher) findViewById(R.id.viewFlipper);
		...
		// NICKNAME
		final EditText nicknameText = (EditText) findViewById(R.id.nicktext);
		...
		Button confirmNick = (Button) findViewById(R.id.confirmNick); 
		...
		TextView loginExisting = (TextView)findViewById(R.id.loginexisting);
			  ...
			  try{
				  if(msg.what == GO_HOME){
					...
					current.dismiss();
					  ...
					  vs.showNext();
					  LinearLayout fbandlogin = (LinearLayout) findViewById(R.id.fbandlogin);
