...
public class BeintooPlayer {
	...
	public Player playerLogin(String userExt, String guid, String codeID, String deviceUUID, String language, String publicname) {
		...
		String apiUrl = BeintooSdkParams.apiUrl+"player/login?";
	...
	public Message playerLogout (String guid, String codeID){
		String apiUrl = BeintooSdkParams.apiUrl+"player/logout";
	...
	public Player getPlayer (String guid, String codeID){
		String apiUrl = BeintooSdkParams.apiUrl+"player/byguid/"+guid;
	...
	public Message submitScore (String guid, String codeID, String deviceUUID, int lastScore, int balance,
		...
		String apiUrl = BeintooSdkParams.apiUrl+"player/submitscore/?lastScore="+lastScore;
