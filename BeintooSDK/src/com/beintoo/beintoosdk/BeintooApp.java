...
public class BeintooApp {
	...
	public void TopVGood(String codeID){
		...
		String apiUrl = BeintooSdkParams.apiUrl+"app/topvgood";
	...
	public Map<String, List<EntryCouplePlayer>> TopScore(String codeID, int rows){
		String apiUrl;
		if(rows != 0)
			apiUrl = BeintooSdkParams.apiUrl+"app/topscore?rows="+rows;
		else
			apiUrl = BeintooSdkParams.apiUrl+"app/topscore";
	...
	public Map<String, List<EntryCouplePlayer>> TopScoreByUserExt(String codeID, int rows, String userExt){
		String apiUrl;
		if(rows != 0)
			apiUrl = BeintooSdkParams.apiUrl+"app/topscore/"+userExt+"?rows="+rows;
		else
			apiUrl = BeintooSdkParams.apiUrl+"app/topscore/"+userExt;
